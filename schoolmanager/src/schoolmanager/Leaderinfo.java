...
public class Leaderinfo extends JPanel{
	//创建各种成员变量
			...
			Storesystem3 store = new Storesystem3();//创建存储对象容器
			Connection con = store.getConnection();//获取数据库连接对象
			//Addframe3 af = new Addframe3();
			Addframe3 af3;
			//创建添加方法
			...
			public Leaderinfo(String str,String sql) {//构造函数
				...
				//设置关闭方法
				leaderinfoframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				leaderinfoframe.setSize(WIDTH, HEIGHT);//设置窗口大小
				//创建和设置对象kit，并使组件居中显示
				...
				leaderinfoframe.setLocation(x, y);//窗口位置
				leaderinfoframe.setVisible(true);//窗口显示
				leaderinfoframe.add(this,BorderLayout.CENTER);//创建布局管理器
				...
				Vector vec = store.getleader(con, sql);//获取容器对象
				...
				bereturn.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent Event) {
						// TODO 自动生成的方法存根
						Leadermanageframe manageframe = new Leadermanageframe();
				...
				update.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent Event) {
						// TODO 自动生成的方法存根
						String name1=af3.ss.getName();
						   String code1= af3.ss.getCode();
			                String age1= af3.ss.getAge();
			                String sexy1= af3.ss.getSexy();
			                String birthday1= af3.ss.getBirthday();
			                String address1= af3.ss.getAddress();
			                String salary1= af3.ss.getSalary();
			                String major1= af3.ss.getMajor();             
			                String duty1= af3.ss.getDuty();             
